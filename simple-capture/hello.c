...
# 4 "simple-capture.c" 2
# 1 "/usr/include/pcap.h" 1 3 4
# 45 "/usr/include/pcap.h" 3 4
# 1 "/usr/include/pcap/pcap.h" 1 3 4
# 47 "/usr/include/pcap/pcap.h" 3 4
...
# 48 "/usr/include/pcap/pcap.h" 2 3 4



# 1 "/usr/include/pcap/bpf.h" 1 3 4
# 67 "/usr/include/pcap/bpf.h" 3 4
typedef int bpf_int32;
typedef u_int bpf_u_int32;
# 88 "/usr/include/pcap/bpf.h" 3 4
struct bpf_program {
 u_int bf_len;
 struct bpf_insn *bf_insns;
};
# 104 "/usr/include/pcap/bpf.h" 3 4
struct bpf_version {
 u_short bv_major;
 u_short bv_minor;
};
# 904 "/usr/include/pcap/bpf.h" 3 4
struct bpf_insn {
 u_short code;
 u_char jt;
 u_char jf;
...
# 918 "/usr/include/pcap/bpf.h" 3 4
extern int bpf_validate(const struct bpf_insn *, int);
extern u_int bpf_filter(const struct bpf_insn *, const u_char *, u_int, u_int);
# 52 "/usr/include/pcap/pcap.h" 2 3 4
# 74 "/usr/include/pcap/pcap.h" 3 4
typedef struct pcap pcap_t;
typedef struct pcap_dumper pcap_dumper_t;
typedef struct pcap_if pcap_if_t;
typedef struct pcap_addr pcap_addr_t;
# 116 "/usr/include/pcap/pcap.h" 3 4
...
# 136 "/usr/include/pcap/pcap.h" 3 4
typedef enum {
       PCAP_D_INOUT = 0,
       PCAP_D_IN,
       PCAP_D_OUT
} pcap_direction_t;
# 154 "/usr/include/pcap/pcap.h" 3 4
struct pcap_pkthdr {
 struct timeval ts;
 bpf_u_int32 caplen;
 bpf_u_int32 len;
...
# 208 "/usr/include/pcap/pcap.h" 3 4
struct pcap_if {
 struct pcap_if *next;
 char *name;
 char *description;
...
typedef void (*pcap_handler)(u_char *, const struct pcap_pkthdr *,
        const u_char *);
# 256 "/usr/include/pcap/pcap.h" 3 4
...
# 280 "/usr/include/pcap/pcap.h" 3 4
...
# 379 "/usr/include/pcap/pcap.h" 3 4
int pcap_get_selectable_fd(pcap_t *);
# 45 "/usr/include/pcap.h" 2 3 4
# 5 "simple-capture.c" 2
